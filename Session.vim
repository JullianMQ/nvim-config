...
badd +24 lua/kickstart/plugins/which-key.lua
badd +135 lua/keymaps.lua
badd +125 lua/custom/plugins/init.lua
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 125 - ((23 * winheight(0) + 22) / 44)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 24 - ((15 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 24
